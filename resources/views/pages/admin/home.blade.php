        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid bg-light ">
                    <div class="row">
                        <div class="col">
                            <h3 class="mt-4 text-success">Data Perkara</h3>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal-{{$perkaraData->perkara_id}}">
                                                Edit
                                            </button>
                                    ...
                                    <!-- Modal Edit-->
                                    <div class="modal fade" id="editModal-{{$perkaraData->perkara_id}}" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('perkara.edit', $perkaraData->perkara_id)}}" method="POST" enctype="multipart/form-data" class="row g-3">
                                                        @csrf
                                                        @method('post')
                                                        <div class="col-6">
                                                            <p class="fs-5 my-auto mx-auto">Nomor Perkara</p>
                                                        ...
                                                        <div class="col-6">
                                                            <input class="form-control" type="text" id="nomor_perkara" name="nomor_perkara" value="{{$perkaraData->nomor_perkara}}" placeholder="Nomor Perkara" aria-label="default input example">
                                                        </div>
                                                        <div class="col-6">
                                                            <p class="fs-5 my-auto mx-auto">Tanggal Pendaftaran</p>
                                                        </div>
                                                        <div class="col-6">
                                                            <input type="date" name="tgl_pendaftaran" id="tgl_pendaftaran" class="form-control" value="{{$perkaraData->tgl_pendaftaran}}"required>
                                                        </div>
                                                        <div class="col-6">
                                                            <p class="fs-5 my-auto mx-auto">Klasifikasi Perkara</p>
                                                        </div>
                                                        <div class="col-6">
                                                            <input class="form-control" type="text" id="klasifikasi" name="klasifikasi" placeholder="Klasifikasi Perkara" aria-label="default input example" value="{{$perkaraData->klasifikasi}}">
                                                        </div>
                                                        <div class="col-6">
                                                            <p class="fs-5 my-auto mx-auto">Penggugat</p>
                                                        </div>
                                                        <div class="col-6">
                                                            <input class="form-control" type="text" id="penggugat" name="penggugat" placeholder="Penggugat" aria-label="default input example" value="{{$perkaraData->penggugat}}">
                                                        </div>
                                                        <div class="col-6">
                                                            <p class="fs-5 my-auto mx-auto">Email Penggugat</p>
                                                        </div>
                                                        <div class="col-6">
                                                            <input class="form-control" type="email" id="email" name="email" placeholder="Email Penggugat" aria-label="default input example" value="{{$perkaraData->email}}">
                                                        </div>
                                                        <div class="col-6">
                                                            <p class="fs-5 my-auto mx-auto">Tergugat</p>
                                                        </div>
                                                        <div class="col-6">
                                                            <input class="form-control" type="text" id="tergugat" name="tergugat" placeholder="Tergugat" aria-label="default input example" value="{{$perkaraData->tergugat}}">
                                                        </div>
                                                        <div class="col-6">
                                                            <p class="fs-5 my-auto mx-auto">Perkara Tingkat</p>
                                                        </div>
                                                        <div class="col-6">
                                                            <input class="form-control" type="text" id="perkara_tingkat" name="perkara_tingkat" placeholder="Perkara Tingkat" aria-label="default input example" value="{{$perkaraData->perkara_tingkat}}">
                                                        </div>
                                                        <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                        <button type="submit" class="btn btn-success">Simpan</button>
